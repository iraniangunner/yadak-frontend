...
/*
|--------------------------------------------------------------------------
| مسیر فایل: src/app/staff/_components/StaffDashboardContent.tsx
|--------------------------------------------------------------------------
*/
...
const quickLinks = [
  {
    ...
    label: "سفارش‌ها",
    icon: <ShoppingBag />,
    roles: ["warehouse", "sales", "support"],
  },
  {
    href: "/staff/returns",
    label: "مرجوعی‌ها",
    icon: <AssignmentReturn />,
    roles: ["warehouse", "support"],
  },
  {
    href: "/staff/products",
  ...
  {
    href: "/staff/my-referral",
    label: "کد معرف و پورسانت من",
    icon: <Loyalty />,
    roles: ["sales"],
  },
];
