...
|--------------------------------------------------------------------------
| ⚠️ این کامپوننت الان "use client" شد (قبلاً سرور بود) چون embla-carousel
| نیاز به useState/useEffect و تعامل مرورگر داره. products همچنان از
| والدِ سرور (صفحه‌ی هومپیج) به‌عنوان prop میاد - خودِ داده هنوز SSR ـه،
| فقط چیدمانِ اسکرول‌شونده‌ش کلاینتیه.
*/
